...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { end_at: @slot.end_at, start_at: @slot.start_at, status: @slot.status, title: @slot.title, user_id: @slot.user_id } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { end_at: @slot.end_at, start_at: @slot.start_at, status: @slot.status, title: @slot.title, user_id: @slot.user_id } }
